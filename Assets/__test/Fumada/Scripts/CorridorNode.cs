...
public class CorridorNode : Node
{
    ...
    private void ProcessRoomInRelationRightOrLeft(Node structure1, Node structure2)
    {
        ...
        var possibleNeighboursInRightStructuredList = rightStructureChildren.Where(
        ...
        if(possibleNeighboursInRightStructuredList.Count <= 0){
            rightStructure = structure2;
        } else {
            rightStructure = possibleNeighboursInRightStructuredList[0];
        }
        int y = GetValidYForNeighbourLeftRight(leftStructure.TopLeftAreaCorner, leftStructure.BottomLeftAreaCorner,
        ...
        while(y==-1 && sortedLeftStructure.Count > 0)
        {
            ...
            leftStructure = sortedLeftStructure[0];
            y = GetValidYForNeighbourLeftRight(leftStructure.TopLeftAreaCorner, leftStructure.BottomLeftAreaCorner,
                rightStructure.TopLeftAreaCorner,
                rightStructure.BottomLeftAreaCorner);
        }
    ...
    {
        if(rightNodeDown.y >= leftNodeUp.y && leftNodeDown.y >= rightNodeUp.y){
